...
//#define CLOCK_HSI //use internal RC-generator
#define CLOCK_HSE //use external XTAL 8 MHz
//#define CLOCK_MCO //output system clock to the PA8 port

//#define USE_KEYBOARD //use preset select buttons instead of jumpers
#define USE_LEDS_MUX //use mux for LEDs conrol
#define SPI_DIV 1 //SPI clock divider (0 = APB2/2, 1 = APB2/4 ... 7 = APB2/256)
