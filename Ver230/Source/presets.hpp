...
//TR0 - AVG, TR1 - QPPM, TR2 - PPM, TR3 - HOLD,
//TR4 - AVG, TR5 - QPPM, TR6 - PPM, TR7 - HOLD, TR8 - ST, TR9 - MEM
...
//TR0 - AVG, TR1 - QPPM, TR2 - PPM, TR3 - HOLD,
//TR4 - AVG, TR5 - QPPM, TR6 - PPM, TR7 - HOLD, TR8 - ST, TR9 - MEM
static const uint16_t LEDS_P2 = TR1 + TR5 + TR7 + SCALE; //leds set
#elif defined(USE_LEDS_MUX)
...
//TR0 - AVG, TR1 - QPPM, TR2 - PPM, TR3 - HOLD,
//TR4 - AVG, TR5 - QPPM, TR6 - PPM, TR7 - HOLD, TR8 - ST, TR9 - MEM
static const uint16_t LEDS_P3 = TR1 + SCALE; //leds set
#elif defined(USE_LEDS_MUX)
...
//TR0 - AVG, TR1 - QPPM, TR2 - PPM, TR3 - HOLD,
//TR4 - AVG, TR5 - QPPM, TR6 - PPM, TR7 - HOLD, TR8 - ST, TR9 - MEM
static const uint16_t LEDS_P4 = TR0 + TR6 + TR7 + SCALE; //leds set
#elif defined(USE_LEDS_MUX)
